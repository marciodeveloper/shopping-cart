                ...
                <div class="dropdown-menu">
                        ...
                        @foreach(session('cart') as $id => $details)
                            <div class="row cart-detail">
                                ...
                                <div class="col-lg-8 col-sm-8 col-8 cart-detail-product">
                                    <p>{{ $details['name'] }}</p>
                                    <span class="price text-info"> R${{ $details['price'] }}</span> <span class="count"> Quantidade:{{ $details['quantity'] }}</span>
                                </div>
                            </div>
                        @endforeach
                    @endif
                    <div class="row">
                        <div class="col-lg-12 col-sm-12 col-12 text-center checkout">
                            <a href="{{ url('cart') }}" class="btn btn-primary btn-block">Ver Tudo</a>
                        </div>
                    </div>
                </div>
            </div>
